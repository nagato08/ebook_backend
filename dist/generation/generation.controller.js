...
const verified_email_guard_1 = require("../common/guards/verified-email.guard");
const current_user_decorator_1 = require("../auth/current-user.decorator");
const generation_service_1 = require("./generation.service");
const book_dto_1 = require("../books/dto/book.dto");
let GenerationController = class GenerationController {
    generation;
    constructor(generation) {
        this.generation = generation;
    }
    generate(user, id, dto) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(verified_email_guard_1.VerifiedEmailGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, book_dto_1.GenerateBookDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], GenerationController.prototype, "status", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], GenerationController.prototype, "unlock", null);
exports.GenerationController = GenerationController = __decorate([
    (0, common_1.Controller)('books/:id'),
